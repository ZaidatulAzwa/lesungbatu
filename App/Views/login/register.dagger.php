      ...
      <section class="ftco-section ftco-services">
        ...
        <div class="container">
          <div class="row justify-content-center mb-5 pb-3">
            ...
            <center>
              <h1 style="color:black">Page Register</h1><br>
              <?php echo get_error("FailLogin"); ?>
              <form action="register" method="POST"> <?php  Html::csrf(); ?>
              <div class="form-group">
                <label for="email"><b>Email:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
                <input type="text" name="user_email" required>
              </div>
              <div class="form-group">
                <label for="email"><b>Username:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
                <input type="text" name="user_username" required>
              </div>
              <div class="form-group">
                <label for="pwd">Password:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                <input type="password" name="user_password" id="pwd">
              </div>
              <div class="form-group">
                <label for="psw-repeat"><b>Repeat Password:&nbsp</b></label>
                <input type="password" name="user_password_repeat" required>
              </div><br>
              <a href="login" class="btn btn-default" style="color:black">Log In</a>
