	    ...
	    <div class="container">
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
              ...
              <li class="nav-item"><a href="/lesungbatu/bahanmasakan" class="nav-link">Bahan Masakan</a></li>
  	          ...
  	          <li class="nav-item"><a href="/lesungbatu/kegemaranuser" class="nav-link">Kegemaran</a></li>
  	        </ul>
  	      </div>
  		  </div>
  	  </nav>
            ...
            <div class="col-md-7 heading-section ftco-animate text-center">
              <center>
                  ...
                  <form action="<?php echo base_url('update/').$singleRow->user_id; ?>" method="post">
                      <?php Html::csrf(); ?>
                      <input type="text" name="name" value="<?php echo $singleRow->user_username;?>"> <br>
                      <p style="font-weight: bold">Sila tukar username awak diruang URL <br> contoh seperti /update/abu</p><br>
                      <div class="form-group">
                        <label for="email"><b>New Email:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
                    ...
                    <input type="submit" style="font-weight:bold" class="ml-2 btn btn-white btn-outline-black">
                  </form>
              </center>
      		</div>
      	</div>
