    ...
    <section class="ftco-section ftco-services">
    	...
    	<div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Resepi Menarik </h2><br>
          </div>
        </div>
    		<div class="row">
          <div class="col-md-4 ftco-animate">
            <div class="media d-block text-center block-6 services">
              <div class="icon d-flex justify-content-center align-items-center mb-5">
	               <img src="/lesungbatu/public/images/a.jfif">
              </div>
              <div class="media-body">
                <h3 class="heading">Ayam Korea Pedas</h3><br><br>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="media d-block text-center block-6 services">
              <div class="icon d-flex justify-content-center align-items-center mb-5">
               <img src="/lesungbatu/public/images/a2.jfif">
              </div>
              <div class="media-body">
                <h3 class="heading">Kambing grilled</h3><br><br><br>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="media d-block text-center block-6 services">
              <div class="icon d-flex justify-content-center align-items-center mb-5">
             <img src="/lesungbatu/public/images/a1.jfif">
              </div>
              <div class="media-body">
                <h3 class="heading">Ayam Buttermilk</h3><br><br>
              </div>
            </div>
          </div>
        </div>
    				...
    				<div class="services-wrap d-flex">
    					<div class="text p-4">
    				  	...
    				  	<img src="/lesungbatu/public/images/a5.jfif"><br><br>
    						<a href="MasakanMelayuTradisi" class="ml-2 btn btn-white btn-outline-white">Dapatkan !</a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-lg-4 d-flex ftco-animate">
	               ...
	               <img src="/lesungbatu/public/images/a6.jfif"><br><br>
    						<a href="MasakanWestern" class="ml-2 btn btn-white btn-outline-white">Dapatkan !</a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-lg-4 d-flex ftco-animate">
	               ...
	               <img src="/lesungbatu/public/images/a7.jfif"><br><br>
    						<a href="MasakanThai" class="ml-2 btn btn-white btn-outline-white">Dapatkan !</a></p>
    					</div>
    				</div>
    			</div>
    		</div>
