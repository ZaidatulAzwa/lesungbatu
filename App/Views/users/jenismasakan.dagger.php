          ...
          <div class="col-lg-4 d-flex ftco-animate">
            <div class="services-wrap d-flex">
              <div class="text p-4">
                ...
                <a href="MasakanChinese" class="ml-2 btn btn-white btn-outline-white">Dapatkan !</a></p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 d-flex ftco-animate">
            <div class="services-wrap d-flex">
              <div class="text p-4">
                ...
                <a href="MasakanIndian" class="ml-2 btn btn-white btn-outline-white">Dapatkan !</a></p>
              </div>
            </div>
          </div>
        </div>
